...
- Med **segmenteksport** kan du eksportere segmentobjekter fra Customer Insights. Segmenter repræsenterer en liste over kundeprofiler. Når du konfigurerer eksporten, skal du vælge de inkluderede datafelter, afhængigt af det målsystem du eksporterer data til. 
