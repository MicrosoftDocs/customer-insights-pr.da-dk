---
title: Oprette målinger med målergeneratoren
...
ms.locfileid: "9170842"
---
# <a name="create-measures-with-measure-builder"></a>Oprette målinger med målergeneratoren

Med målgeneratoren kan du definere beregninger ved hjælp af regneoperatører, aggregeringsfunktioner og filtre. Definer målinger med attributter fra objekter, der er relateret til objektet samlet *Kunde*.
...
1. Hvis du vil tilføje flere beregninger for målingen, skal du vælge **Ny beregning**. Du kan kun bruge objekter på samme objektsti til nye beregninger. Flere beregninger vises som nye kolonner i objektet til måling af output. Vælg eventuelt Rediger navn **for at** oprette et navn til beregningen.

1. Vælg den lodrette ellipse (&vellip;) i beregningen for at **Duplikere** eller **Fjerne** en beregning fra en måling.
...
1. Vælg **Kør** for at beregne resultaterne for det konfigurerede mål. Vælg **Gem og luk**, hvis du vil bevare den aktuelle konfiguration og køre målingen senere. Siden **Målinger** vises.
...
1. Vælg **Dimension** for at vælge flere felter, der skal føjes som kolonner til objektet Output.
   ...
   1. Vælg **Rediger dimensioner** for at tilføje dataattributter, som du vil gruppere måleværdierne efter. Det kan f.eks. være by eller køn.
      > [!TIP]
      > Hvis du har valgt Kundeniveau som Måltype er attributten *CustomerId* allerede tilføjet. Hvis du fjerner attributten, skifter måltype til forretningsniveau.
   1. Vælg **Gennemført** for at tilføje dimensioner til målingen.

1. Hvis der er værdier i dataene, som du skal erstatte med et heltal, skal du vælge **Regler**. Konfigurer reglen, og sørg for kun at vælge hele tal som erstatninger. Erstat f.eks. *null* med *0*.

1. Du kan [bruge konti med hierarkier](relationships.md#set-up-account-hierarchies), gennemse **Akkumuler underordnede firmaer**.
